...
%   Write output
    ...
    fprintf ('\n') 
    fprintf ('Link From   To         AC1    AC2   AC3    Total (indirect) (Revenue per Seat)  (Revenue) (ASK)  (RASK) (CASK) (RPK) (Profit) (Yield) (ALF) (BELF)\n');
    NL      =   0;
    alf_array = [];
    belf_array = [];
    profit_array = [];
    ...
    for i = 1:Nodes
        for j = 1:Nodes
            if sol.Flow(i,j,1)+sol.Flow(i,j,2)+sol.Flow(i,j,3)>0
                ...
                fprintf (' %2d  %s   %s  %5d  %5d %5d %6d  %5d  %5d  %5d 5%d %5d %5d %5d %5d %5d %5d %5d\n', NL, Airport_name{i}, ...
                            Airport_name{j}, sol.Flow (i,j,1), sol.Flow (i,j,2), ...
                            sol.Flow (i,j,3), sol.Flow (i,j,1)+sol.Flow (i,j,2)+sol.Flow(i,j,3), indirect,...
